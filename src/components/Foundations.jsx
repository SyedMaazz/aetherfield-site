      ...
      >
        ...
        <div className="w-[420px] flex flex-col items-start text-left">
          <h2 className="text-[20px] font-nav font-medium text-black leading-tight mb-3.5 -pt-2 tracking-tight">
            Why Acme Inc chose Aetherfield<br /> 
          </h2>
          ...
          <p className="text-black font-serif text-[20px] mb-8 -tracking-[0.03rem] leading-[1.2]">
            ...
            Aetherfield to streamline their ESG workflows. The result?  
            Faster decisions, fewer spreadsheets, and 34% more coverage.
          </p>

          {/* THE BUTTON */}
          <button className="px-3 py-2 bg-black text-white font-nav text-[14px] font-light tracking-[0.09rem]">
            Read case study
          </button>
        </div>
